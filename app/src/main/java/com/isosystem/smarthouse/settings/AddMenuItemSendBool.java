	...
	private OnClickListener tooltipsButtonListener = new OnClickListener() {
		...
		public void onClick(final View v) {
			...
			case R.id.button_help_outgoing_prefix:
				tooltip = "Сообщение со значением 0 или 1, которое будет выслано контроллеру. Настройщик вводит префикс сообщения. При отсылке, программа возьмет булевое значение и вышлет сообщение <[префикс][,][0 или 1]>";
				break;
			default:
